...
REPORT_MANIFEST: tuple[ReportManifestEntry, ...] = (
    ...
    ReportManifestEntry(
        ...
        status="schema_ready_no_live_context",
        data_period="not populated",
        source="TCMB/EVDS, TUIK, Federal Reserve, legal news, instructor-approved video planned",
        sample_size="0 verified live context records committed",
        assumptions="source_access and publication/download timestamps required",
        limitations="source access and licensing still need verification",
    ),
    ReportManifestEntry(
